        ...
        $builder
            ...
            ->add('numPuce', TextType::class, [
                ...
                'constraints' => [
                    new Length([
                        'min' => 6,
                        'minMessage' => 'Le numéro doit comporter {{ limit }} caractères minimum',
                        'max' => 15,
            ...
            ->add('infoSup', TextareaType::class, [
                ...
                'attr' => [
                    ...
                    'placeholder' => 'Précautions, caractère de l’animal, sociabilité, peurs, phobie, éducation, antécédents de santé, traitement médical, dernières chaleurs etc…'
                ]
            ]);
    }
